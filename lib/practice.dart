...
import 'package:flutter_quiz_app/practice_result.dart';
import 'quiz.dart';
import 'dart:math';
...
class _PracticeState extends State<Practice> {
  ...
  void method(){
    skey.currentState?.showSnackBar(const SnackBar(content: Text('No Bookmarks Found!!!')));
  }
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: _questionNumber < 5
            ? Quiz(
          answerQuestion: _answerQuestion,
          questionIndex: _questionIndex,
          questions: _questions,
        )
            : Practice_Result(_totalScore),
      ),
    );
  }
}
